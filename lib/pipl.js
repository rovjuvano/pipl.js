...
PIPL.SimpleProcess = (function() {
  function SimpleProcess(engine, channel_id, name_ids, replicate, new_names, parent) {
    this.engine = engine;
...
PIPL.ReadProcess = (function(_super) {
  ...
  ReadProcess.prototype.proceed = function(refs) {
    this.engine.enqueue('read', refs.get(this.channel_id), new PIPL.ReadHandler(this, refs));
  };
...
PIPL.SendProcess = (function(_super) {
  ...
  SendProcess.prototype.proceed = function(refs) {
    this.engine.enqueue('send', refs.get(this.channel_id), new PIPL.SendHandler(this, refs));
  };
...
PIPL.ComplexProcess = (function() {
  ...
  ComplexProcess.prototype.read = function(channel_id, name_ids, replicate, new_names) {
    var p = make_step(this.engine, PIPL.ReadProcess, channel_id, name_ids, replicate, new_names, this);
    this.processes.push(p);
    return p;
  };

  ComplexProcess.prototype.send = function(channel_id, name_ids, replicate, new_names) {
    var p = make_step(this.engine, PIPL.SendProcess, channel_id, name_ids, replicate, new_names, this);
    this.processes.push(p);
    return p;
  };
